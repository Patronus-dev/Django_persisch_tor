    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(help_text='Enter your phone number.', max_length=15, region='DE', unique=True, verbose_name='Phone Number')),
                ('email', models.EmailField(blank=True, help_text='Enter your Email address.', max_length=254, null=True, unique=True, verbose_name='E-Mail')),
